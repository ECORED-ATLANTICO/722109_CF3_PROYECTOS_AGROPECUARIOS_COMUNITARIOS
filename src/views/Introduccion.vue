...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        p(data-aos="fade-left") Es en el año de 1979 que la Agencia para el Desarrollo Internacional de los Estados Unidos (USAID) divulga oficialmente el Enfoque de Marco Lógico a través de la publicación “<em>The Logical Framework</em>”, como una herramienta eficaz para la gestión de la información requerida en la formulación de proyectos, respondiendo a tres necesidades identificadas y explícitas en la publicación de la metodología en ese entonces: una planeación demasiado “vaga”, la falta de claridad en las responsabilidades y la dificultad del proceso de evaluación. El Enfoque de Marco Lógico (<em>The Logical Framework Approach</em>) responde específicamente a estas necesidades, propendiendo desde el inicio de la formulación a: 
            ol.my-3.lista-ol(style="list-style-position: outside; padding-left: 1.8em; text-indent: -1.4em;")
              li(data-aos="fade-left") 
                span(style="color: #78A492").text-bold A. 
                | Una descripción clara, explícita y medible de lo que sucederá si el proyecto es exitoso.
              li(data-aos="fade-left")  
                span(style="color: #78A492").text-bold B. 
                | El esclarecimiento de la responsabilidad de la gerencia del proyecto y el porqué de esto. 
              li(data-aos="fade-left")  
                span(style="color: #78A492").text-bold C. 
                | La visualización de los elementos clave de diseño del proyecto y sus relaciones entre sí de manera que facilita el análisis.
              li(data-aos="fade-left")  
                span(style="color: #78A492").text-bold D. 
                | Cambiando el enfoque de búsqueda de culpables a un enfoque de búsqueda del plan más realista para el logro de los objetivos según la evidencia disponible en el momento (PCI, 1979).
      ...
      .col-lg-8
        p(data-aos="fade-right")  
          ...
          ul.my-3(style="list-style-position: outside; padding-left: 3em; text-indent: -0.6em;")
            ...
            li(data-aos="fade-right", style="list-style-type: disc; color: #78A492; font-size: 1.2em;")
              span(style="color: #12263F; font-size: 0.88em; margin: 0.5em") Definir el área de responsabilidad del equipo del proyecto.
            li(data-aos="fade-right", style="list-style-type: disc; color: #78A492; font-size: 1.2em;")
              span(style="color: #12263F; font-size: 0.88em; margin: 0.5em") Establecer indicadores para el seguimiento y la evaluación.
        .cajon.cajon.color-acento-contenido(data-aos="fade-right",style="background: #FFF6DE").p-4.my-3
          p.mt-0 
            | Esta adaptación ofrece modificaciones muy útiles, porque ha tenido un destacable éxito en su aplicación y una gran aceptación en todos los entornos que la han adoptado.  
      .col-lg-4.col-md-8.mx-auto
        figure
          img.my-3(data-aos="fade-left",src="@/assets/curso/temas/intro/img3.png", alt="")
    .row.justify-content-center
      hr(style="background:#FF9751; height: 2px; width: 79%")

    .row.justify-content-center 
      .col-lg-10
        .bloque-texto-b.py-5.pt-4.px-5.mb-5.mt-2
    ...
    .row.aling-center-my-2
      .col-lg-6(data-aos="fade-right")
        p En general, el EML tiene cada vez más aceptación en muchos ámbitos, instituciones y países debido al significativo aporte que ofrece la metodología a la gerencia y la gestión de proyectos y programas, fomentando el liderazgo, el direccionamiento estratégico, la conducción de procesos complejos y la construcción de entornos favorables (involucrando actores importantes), facilitando la toma de decisiones y la calidad de las propuestas, aplicando criterios de eficiencia en la planeación y operación, la capacidad de adaptación a circunstancias cambiantes y la implicación sin mayores traumatismos de variables difíciles de cuantificar como las de impacto social. 
      .col-lg-6(data-aos="fade-left")
        p Finalmente, el enfoque metodológico de Marco Lógico es un medio, por lo que no podrá subsanar fallas en las políticas macroeconómicas o de planes maestros como los gubernamentales; además, los análisis iniciales deberán estar bien planteados para el logro de los resultados esperados con la aplicación del enfoque y esto estará condicionado por la calidad de la información y de los insumos de los que se disponga. En este documento se abordan los pasos iniciales para la aplicación de la metodología, comenzando por las distintas herramientas complementarias que siguen un orden secuencial, hasta la construcción de la Matriz de Marco Lógico (MML), el producto final que resume el enfoque. 
    .row.my-3
      .col-lg-10.crd--avatarHorizontal-left-borde-tarjeta.py-3.mb-3.m-auto.fondo_tarjeta_intro
    ...
    .row.align-items-center.justify-content-center
      .col-lg-10
          .container.tarjeta.tarjeta--blanca.p-4.p-md-5
            ...
            figure
              img(data-aos="fade-up",src='@/assets/curso/temas/intro/img5.png', alt='Se puede apreciar un cultivo de quinua.')
              figcaption.my-3.text-regular <strong>Nota.</strong> Tomado de archivo de AgroSENA. SENA (2020). 
</template>
