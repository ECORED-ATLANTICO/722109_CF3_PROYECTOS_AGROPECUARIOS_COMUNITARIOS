export default {
  ...
  complementario: [
    {
      tema: 'Canal en You tube de Ligorio Dussan',
      referencia:
  ...
  referencias: [
    ...
    {
      referencia:
        'Geilfus, F. (2002). <em>80 herramientas para el desarrollo participativo. Diagnóstico, planificación, monitoreo y evaluación</em>. Instituto Interamericano de Cooperación para la Agricultura (IICA).',
      link:
    ...
    {
      referencia:
        'Sarandón, S. (2020). <em>Cuadernos de la transformación: El papel de la agricultura en la transformación social-ecológica de América Latina</em>. Friedrich-Ebert-Stiftung.',
